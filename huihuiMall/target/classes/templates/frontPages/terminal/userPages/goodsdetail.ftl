                ...
                <div class="col-lg-12 col-md-12 col-xs-12 goods">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 goods-detail-panel">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 goods-param-panel">
                            <div class="col-lg-3 col-md-3 col-xs-3 goods-param-title">
                                <span>商品参数：</span>
                            </div>
                            <div class="col-lg-9 col-md-9 col-xs-9 goods-param">
                                <div class="col-lg-12 col-md-12 col-xs-12 goods-param-detail">
