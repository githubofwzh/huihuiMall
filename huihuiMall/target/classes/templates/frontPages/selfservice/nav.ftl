        ...
        <div class="row">
            <div class="title col-lg-12 col-xs-12 col-sm-12">
                ...
                <div class="col-lg-9 col-xs-9 col-sm-9 user text-right right" style="padding: 0">
                    <span>欢迎您,<span class="hellowPhone"></span></span>
                    ...
                    <button onclick="SignOut();" class="return"><img src="${bath}/images/frontpages/common/SignOut.png" />退出</button>
                </div>
            </div>
        </div>
    </div>
