...
<script>
    ...
    function getUserInfos(pageCount,currentPageNum){
        ...
        $.ajax({
            type : "get", //用POST方式传输
            url : '${bath}/financialReport/dayReport', //目标地址
            data : {
            ...
            success : function(retInfo) {
                ...
                if(retCode != 0){
                    ...
                    for(var i = 0 ;i < retDataLength; i ++){
                        ...
                        var ordercount = retData[i].ordercount;
       ...
       function excelExport(pageCount,currentPageNum,startingDate,endingDate){
           ...
           window.location.href="${bath}/FinanncialReportExecel/dayReport?param="+param;
            }
