...
<#if _csrf??>
    ...
    <link href="${bath}/css/viewer/viewer.min.css" rel="stylesheet" type="text/css"/>
    ...
    <script src="${bath}/js/imgJS/viewer/viewer.min.js" type="text/javascript"></script>
...
<div class="container-fluid btn-operation-panel">
    <div class="row">
        <#--<div class="col-lg-12 col-md-12 col-xs-12 admin-search-panel" style="display:none">
            &lt;#&ndash;管理员显示开始&ndash;&gt;
            <span>商家名称：</span>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 business-search-panel">
            <#--商家显示开始-->
            <span>商品名称：</span>
            <input type="text" id="searchKey" class="shopName" placeholder="请输入商品名称">

            <span style="margin-left: 10px">上下架状态：</span>
            <select style="width: 10%" class="TheShelves">
            ...
            <select style="width: 10%" class="ToExamine">
                <option value="">请选择</option>
            ...
            <button type="button" class="btn btn-default" id="searchBtn" onclick="getBusinessGoodsInfos();"><i class="fa fa-search fa-fw"></i> 搜索</button>
            <button type="button" class="btn btn-default resetBtn" id=""><i class="fa fa-undo fa-fw"></i> 重置</button>
        </div>
    </div>
</div>
...
<div class="container-fluid table-operation-panel">
    <div class="row table-row">
        <div class="col-lg-12 col-md-12 col-xs-12 table-panel">
            ...
            <#--需根据登录身份判断是否显示操作面板 admin--不显示，商家--显示-->
            <div class="col-lg-12 col-md-12 col-xs-12 btn-group-panel"  style="display: none">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 uploadother">
                                                <div class="col-lg-3 col-md-3 col-xs-3" id="uploadFormOther" style="padding: 0px">
                                                    <a class="col-lg-3 col-md-3 col-xs-3 pic-upload-gp-other" href="javascript:void(0);">
                                                        <span></span>
                                                        <input id="uploadPicOther" name="upfile"  type="file" accept="image/*" >
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
...
<!--admin下架商家商品确认面板开始-->
<div class="panel-body">
    <div class="modal fade" id="offShelfModal" tabindex="-1" role="dialog" aria-labelledby="offShelfModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        &times;</button>
                    <h4 class="modal-title" id="shelfModalLabel">
                        <i class="fa fa-trash-o fa-fw"></i> 上架</h4>
                </div>
                <div class="modal-body">
                    确定要上架该商家的此件商品吗？
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color: #ccc;
                            color: #444444">
                        取消</button>
                    <button type="button" class="btn btn-default" style="margin-top: 0px" id="confirmOffShelf" data-loading-text="操作中..." autocomplete="off">
                        确定</button>
                </div>
            </div>
        </div>
...
<!--商家商品申请上架面板开始-->
<div class="panel-body">
    <div class="modal fade" id="applyOnShelfModal" tabindex="-1" role="dialog" aria-labelledby="applyOnShelfModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        &times;</button>
                    <h4 class="modal-title" id="applyOnShelfModalLabel">
                        <i class="fa fa-trash-o fa-fw"></i> 申请上架</h4>
                </div>
                <div class="modal-body">
                    确定要申请上架此件商品吗？
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color: #ccc;
                            color: #444444">
                        取消</button>
                    <button type="button" class="btn btn-default" style="margin-top: 0px" id="confirmOffShelfShenHe" data-loading-text="操作中..." autocomplete="off">
                        确定</button>
                </div>
            </div>
        </div>
...
<!--商家商品下架开始-->
<div class="panel-body">
    <div class="modal fade" id="businessOffShelfModal" tabindex="-1" role="dialog" aria-labelledby="businessOffShelfModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        &times;</button>
                    <h4 class="modal-title" id="businessOffShelfModalLabel">
                        <i class="fa fa-trash-o fa-fw"></i> 下架</h4>
                </div>
                <div class="modal-body">
                    确定要下架此件商品吗？
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color: #ccc;
                            color: #444444">
                        取消</button>
                    <button type="button" class="btn btn-default" style="margin-top: 0px" id="confirmBusinessOffShelf" data-loading-text="操作中..." autocomplete="off">
                        确定</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if(accountTypeParam != 3){
            $(".btn-group-panel").css("display","block");
        }
        ...
        //查看大图
        var img = document.getElementById("goodsTbody");
        ...
        //第三方商品信息
        getBusinessGoodsInfos(pageCount,currentPageNum);

        //搜索点击
        $("#searchBtn").click(function(){
            $("#Tbody").empty();
            $("#loading").css("display","block");
            getBusinessGoodsInfos(pageCount,1);
        });
        ...
        //下架
        $("#confirmBusinessOffShelf").click(function (){
            ToExamineOut(uId,getToExamine,getTheShelves);
         });
        //上架
        $("#confirmOffShelf").click(function (){
            ToExamineOut(uId,getToExamine,getTheShelves);
        });


        //审核按钮
        $("#confirmOffShelfShenHe").click(function (){
            ToExamine(uId,getToExamine,getTheShelves);
        });
                ...
                $.ajax({
                    ...
                    success : function(retInfo) {
                        ...
                        if (retCode != 0) {
                            ...
                            uploadFormOtherHtml += "<input id='uploadPicOther' name='upfile'  type='file' accept='image/*'>";
                        ...
                        uploadBtnOther.change(function() {
                            ...
                            var file = document.getElementById('uploadPicOther').files[0];  //获取到上传控件对象files
                            ...
                            if (file) {
                                ...
                                reader.onload = function(e){      //当文件成功读取后
                                    ...
                                    picOtherHtml = "<span class='col-lg-3 col-md-3 col-xs-3 item-pic-other' id='imgotherbox"+imgOtherId+"' style='width:80px;height:80px'><img class='' src='" + this.result + "' id='other" + imgOtherId + "'><span class='pic-del-other'></span></span>";

                                    if (uploadother.find('.item-pic-other').length >= 4) {
    ...
    //第三方商品信息
    function getBusinessGoodsInfos(pageCount,currentPageNum){
        toastr.options = {
            "positionClass": "toast-tip-center-center", //弹出窗的位置
            "timeOut": "1000" //展现时间
        };

        var searchKeyParam = $(".shopName").val();
        var TextVal = $(".shopName").val();
        $("#currentPage").html(currentPageNum);
        console.log($(".ToExamine").val());
        console.log($(".TheShelves").val());
        var accountIdParam = sessionStorage.getItem("userId");
        $.ajax({
            type : "POST", //用POST方式传输
            url : '${bath}/productMgmt/getThirdPartyProduct', //目标地址
            data : {
                accountId : accountIdParam,
                name : TextVal,
                reviewStatus : $(".ToExamine").val(),
                shelvesStatus  : $(".TheShelves").val()
            },
            dataType : "json", //数据格式:JSON
            success : function(retInfo) {
                console.log(retInfo);
                ...
                if(retCode != 0){
                    ...
                    for(var i = 0 ;i < retDataLength; i ++){
                        ...
                        var measurement_unit = retData[i].measurement_unit;
                        var categoryonename = retData[i].categoryonename;
                        var categorytwoname = retData[i].categorytwoname;
                        var review_status = retData[i].review_status;
                        var shelves_status = retData[i].shelves_status;

                        var tbodyHtml = "<tr>";
                        tbodyHtml += "<td><input type='checkbox' id='"+uid+"' class='mycheckbox'/></td>";
                        tbodyHtml += "<td>"+index+"</td>";
                        tbodyHtml += "<td>"+name+"</td>";
                        tbodyHtml += "<td>"+code+"</td>";
                        tbodyHtml += "<td>"+brandname+"</td>";
                        tbodyHtml += "<td>"+specifications+"</td>";
                        tbodyHtml += "<td>"+measurement_unit+"</td>";
                        tbodyHtml += "<td>"+categoryonename+"</td>";
                        tbodyHtml += "<td>"+categorytwoname+"</td>";
                        if(review_status==0){
                            review_status="未审核";
                            shelves_status="未上架";
                            tbodyHtml += "<td class='un-shelf'>"+shelves_status+"</td>";
                            tbodyHtml += "<td style='color:#999999'>"+review_status+"</td>";
                            tbodyHtml += "<td><a href='#' data-toggle='modal' data-target='#detailModal' onclick='viewDetail("+uid+");'>查看</a></td>";
                            tbodyHtml += "<td><button type='button' class='btn btn-default on-off-shelf-btn' data-toggle='modal' data-target='#applyOnShelfModal' onclick='getData("+uid+","+1+","+0+","+1+");' >申请审核</button></td>";
                        }else if(review_status==1){
                            review_status="审核中";
                            shelves_status="未上架";
                            tbodyHtml += "<td class='un-shelf'>"+shelves_status+"</td>";
                            tbodyHtml += "<td style='color:orange'>"+review_status+"</td>";
                            tbodyHtml += "<td><a href='#' data-toggle='modal' data-target='#detailModal' onclick='viewDetail("+uid+");'>查看</a></td>";
                            tbodyHtml += '<td><button type="button" class="btn btn-default on-off-shelf-btn disabled">审核中</button></td>';
                        }else if(review_status==2){
                            review_status="审核通过";
                            if(shelves_status==0){
                                shelves_status="未上架";
                                tbodyHtml += "<td class='un-shelf'>"+shelves_status+"</td>";
                                tbodyHtml += "<td style='color:#00ba35'>"+review_status+"</td>";
                                tbodyHtml += "<td><a href='#' data-toggle='modal' data-target='#detailModal' onclick='viewDetail("+uid+");'>查看</a></td>";
                                tbodyHtml += "<td><button type='button' class='btn btn-default on-off-shelf-btn' data-toggle='modal' data-target='#offShelfModal' onclick='getData("+uid+","+2+","+1+","+1+");' >上架</button></td>";
                            }else if(shelves_status==1){
                                shelves_status="已上架";
                                tbodyHtml += "<td class='on-shelf'>"+shelves_status+"</td>";
                                tbodyHtml += "<td style='color:#00ba35'>"+review_status+"</td>";
                                tbodyHtml += "<td><a href='#' data-toggle='modal' data-target='#detailModal' onclick='viewDetail("+uid+");'>查看</a></td>";
                                tbodyHtml += "<td><button type='button' class='btn btn-default on-off-shelf-btn' data-toggle='modal' data-target='#businessOffShelfModal' onclick='getData("+uid+","+2+","+2+","+2+");' >下架</button></td>";
                            }else if(shelves_status==2){
                                shelves_status="已下架";
                                tbodyHtml += "<td class='off-shelf'>"+shelves_status+"</td>";
                                tbodyHtml += "<td style='color:#00ba35'>"+review_status+"</td>";
                                tbodyHtml += "<td><a href='#' data-toggle='modal' data-target='#detailModal' onclick='viewDetail("+uid+");'>查看</a></td>";
                                tbodyHtml += "<td><button type='button' class='btn btn-default on-off-shelf-btn' data-toggle='modal' data-target='#offShelfModal' onclick='getData("+uid+","+2+","+1+","+1+");' >上架</button></td>";
                            }
                            ...
                            shelves_status="未上架";
                            tbodyHtml += "<td class='un-shelf'>"+shelves_status+"</td>";
                            tbodyHtml += "<td style='color:#ff3355'>"+review_status+"</td>";
                            tbodyHtml += "<td><a href='#' data-toggle='modal' data-target='#detailModal' onclick='viewDetail("+uid+");'>查看</a></td>";
                            tbodyHtml += "<td><button type='button' class='btn btn-default on-off-shelf-btn' data-toggle='modal' data-target='#applyOnShelfModal' onclick='getData("+uid+","+1+","+0+","+1+");' >申请审核</button></td>";
                        }
    ...
    //获取参数
    function getData(uid,reviewStatus,shelvesStatus,OutType) {
        type = OutType;
        uId = uid;
        getToExamine = reviewStatus;
        getTheShelves = shelvesStatus;
        console.log(getToExamine);
        console.log(getTheShelves);
        return uId;
        return type;
        return getToExamine;
        return getTheShelves;
    }

    //审核接口
    function ToExamine(uId,getToExamine,getTheShelves) {
       ...
       $.ajax({
           ...
           data : {
               id : uId,
               reviewStatus : getToExamine,
               shelvesStatus : getTheShelves
           },
           dataType : "json", //数据格式:JSON
           success : function(retInfo) {
                console.log(retInfo);
               ...
               if(retCode != 0){
                   ...
                   $("#applyOnShelfModal").modal("hide");
                   toastr.success("申请审核成功！");
                   setTimeout(function(){
                       reset();
                   },2000);
               }
    ...
    //下架接口
    function ToExamineOut(uId,getToExamine,getTheShelves) {
        ...
        $.ajax({
            ...
            success : function(retInfo) {
                ...
                if(retCode != 0){
                    ...
                    $("#offShelfModal").modal("hide");
                    $("#businessOffShelfModal").modal("hide");
                    if(getTheShelves == 2){
                        toastr.success("下架成功！");
                    }else if(getTheShelves == 1){
                        toastr.success("上架成功！");
                    }
                    setTimeout(function(){
                        reset();
    ...
    function reset(){
        ...
        var pageCount = 20;
        $(".shopName").val("");
        $(".TheShelves option:first").prop("selected", "selected");
        $(".ToExamine option:first").prop("selected", "selected");
        $("#loading").css("display","block");
        getBusinessGoodsInfos(pageCount,currentPageNum);
    }
