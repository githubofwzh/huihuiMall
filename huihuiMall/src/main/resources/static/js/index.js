                                ...
                                for(var k = 0; k < childrenList.length; k++) {
                                    ...
                                    if(childThird != null) {
                                        ...
                                        for(var m = 0; m < childThird.length; m++) {
                                            ...
                                            _html += '<li>';
                                            _html += '<a class="menuItem" data-id="' + childThird[m].id + '" href="'+server_context+''+url+'"><i class="fa fa-gear fa-fw"></i>' + childThird[m].name + '</a>';
                                            _html += '</li>'
                                        }
                                        _html += '</ul>';
                                    } else {
                                        ...
                                        _html += '<a class="menuItem" data-id="' + childrenList[k].id + '" href="'+server_context+''+url+'"><i class="fa fa-gear fa-fw"></i>' + childrenList[k].name + '</a>';
                                    }
