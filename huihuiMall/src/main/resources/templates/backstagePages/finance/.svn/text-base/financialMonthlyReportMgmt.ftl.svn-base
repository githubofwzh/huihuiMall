...
<script>
 ...
 var header = $("meta[name='_csrf_header']").attr("content");
    ...
    function getUserInfos(pageCount,currentPageNum){
        ...
        $.ajax({
            type : "POST", //用POST方式传输
            url : '${bath}/financialReport/MonthReport', //目标地址
            data : {
            ...
            success : function(retInfo) {
                ...
                if(retCode != 0){
                    ...
                    for(var i = 0 ;i < retDataLength; i ++){
                        var index = i + 1;
                        var Profit = retData[i].Profit;
                        var Recome = retData[i].Recome;
                        var bank_name = retData[i].bank_name;
                        var bank_number = retData[i].bank_number;
                        var device_code = retData[i].device_code;
                        var name = retData[i].name;
                        var phone_number = retData[i].phone_number;
                        var price = retData[i].price;
                        var shareProfit = retData[i].shareProfit;
                        var store_name = retData[i].store_name;
                        var bing_time = retData[i].bing_time;
                        var tbodyHtml = "<tr>";
                        tbodyHtml += "<td>"+index+"</td>";
                        tbodyHtml += "<td>"+device_code+"</td>";
                        tbodyHtml += "<td>"+store_name+"</td>";
                        tbodyHtml += "<td>"+price+"</td>";
                        tbodyHtml += "<td>"+Profit+"</td>";
                        tbodyHtml += "<td>"+shareProfit+"</td>";
                        tbodyHtml += "<td>"+Recome+"</td>";
                        tbodyHtml += "<td>"+name+"</td>";
                        tbodyHtml += "<td>"+phone_number+"</td>";
                        tbodyHtml += "<td>"+bing_time+"</td>";
                        tbodyHtml += "</tr>";
           ...
           function excelExport(pageCount,currentPageNum,datetime){
             ...
             var param={
              ...
              window.location.href="${bath}/FinanncialReportExecel/MonthReport?param="+param;
            }
