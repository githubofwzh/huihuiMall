...
<div class="container-fluid btn-operation-panel">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            <span>退换货订单号：</span>
            <input type="text" id="searchKey" placeholder="请输入退换货订单号">

            <span style="margin-left: 10px">门店名称：</span>
            <input type="text" id="searchKey" placeholder="请输入门店名称">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 table-panel">
            ...
            <table class="table table-bordered table-hover table-responsive" style="margin-top: 20px;">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#inStoreModal" style="margin:10px">入库</button>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#outStoreModal" style="margin:10px">出库</button>
                    </td>
                </tr>
                </tbody>
            </table>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 input-form">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    <div class="col-lg-3 col-md-3 col-xs-3 title">
                                        <label class="control-label">配送门店：</label>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-xs-8 input-box">
                                        <input type="text" class="form-control required" placeholder="必填" id="">
                                    </div>
