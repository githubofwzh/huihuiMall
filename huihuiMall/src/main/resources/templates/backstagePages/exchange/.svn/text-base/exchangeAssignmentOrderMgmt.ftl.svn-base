        ...
        <div class="col-lg-12 col-md-12 col-xs-12 table-panel">
            <table class="table table-bordered table-hover table-responsive" style="margin-top: 20px;">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#exchangeAssignmentModal" style="margin:0px 10px" id="">派单</button>
                    </td>
                </tr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 input-form">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-xs-8 input-group" style="padding-left: 15px">
                                        <textarea class="form-control required" id="" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 input-form">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-xs-8 input-group" style="padding-left: 15px">
                                        <img src="${bath}/images/common/photo2.png" style="width:100px;height:75px">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--派单弹出面板开始-->
<div class="panel-body">
    <div class="modal fade" id="exchangeAssignmentModal" tabindex="-1" role="dialog" aria-labelledby="exchangeAssignmentModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        &times;</button>
                    <h4 class="modal-title" id="exchangeAssignmentModalLabel">
