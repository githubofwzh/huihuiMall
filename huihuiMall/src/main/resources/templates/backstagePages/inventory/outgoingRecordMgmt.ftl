    ...
    <div class="row table-row">
        <div class="col-lg-12 col-md-12 col-xs-12 table-panel">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 btn-group-panel">
                ...
                <button type="button" class="btn btn-default"  data-toggle='modal' data-target='#detailModal2' id="Printing">
            ...
            success : function(retInfo) {
                ...
                if(retCode != 0){
                    ...
                    for(var i = 0 ;i < retDataLength; i ++){
                        ...
                        var tbodyHtml = "<tr>";
                        tbodyHtml += "<td><input type='checkbox' id='"+id+"' class='mycheckbox' onclick='orderId("+orderNumber+");'/></td>";
    ...
    function reset(){
      ...
      function excelExport(pageCount,currentPageNum,startingDate,endingDate){
             ...
             var param ={
                      ...
                      endTime : endingDateParam,
                      status : ckTypeSelectedParam };
             window.location.href="${bath}/InventoryExecel/OrderOutInventory?param="+param;
            }
