...
public class HttpClientConnectionManager {
	 ...
	 * @throws IOException
     */
	public static JSONObject getMethodExcute(String url) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static JSONObject postMethodExcute(String url,String data) throws IOException {
