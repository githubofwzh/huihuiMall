...
import com.kshl.huihuimall.portal.livingpay.BaseController;
...
public class QmcsController extends BaseController {
     ...
     * @throws ApiException
     */
    @RequestMapping(value = "/startQmcs", method = {RequestMethod.GET, RequestMethod.POST})
    @ResponseBody
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    consumeRequest.setQuantity(3);
                    consumeRequest.setGroupName("A2458419");
                    QmcsMessagesConsumeResponse consumeResponse = client.execute(consumeRequest, accessToken);
                    System.out.println(consumeResponse.getQmcsMessages());
