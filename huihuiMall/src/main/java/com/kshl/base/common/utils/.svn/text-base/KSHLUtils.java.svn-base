 ...
 *
 */
public class KSHLUtils {

	private static Log log = LogFactory.getLog(KSHLUtils.class);
	...
	public static long compareWithCurrentTime(String date, String format) {
		SimpleDateFormat dateFormat = new SimpleDateFormat(format);
		Date now = new Date();
		try {
			Date srcdate = dateFormat.parse(date);
			long nowl = now.getTime();
			long srcl = srcdate.getTime();
			return srcl - nowl;
		}
		catch (Exception e) {
	...
	public static boolean isInTimeZone(String startStr, String endStr, long kuanxian) throws ParseException {
		SimpleDateFormat sdf=new SimpleDateFormat("HH:mm");
		long tStart = sdf.parse(startStr).getTime();
		long tEnd = sdf.parse(endStr).getTime();
		long currentTime = sdf.parse(sdf.format(new Date())).getTime();
		return tStart <= currentTime+kuanxian*60*1000 && currentTime <= tEnd;
	}

	public static boolean isInDateZone(String start, String end) throws ParseException {
	...
	public static boolean isAfterDate(String compareDateStr) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
